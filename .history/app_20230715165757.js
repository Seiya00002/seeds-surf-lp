...
function clickBtn1(){
    ...
    let boxPriceValue = parseInt(boxPrice, 10); // plantsPriceStringを数値に変換
...
// const estimateTable = document.getElementById('estimate_table');

// btn1.addEventListener('click', () => {
//     estimateTable.classList.toggle('estimate_wrapper');
// }, false);

const btn = document.querySelector('.btn-box button');
btn.addEventListener('click', () => {
    const estimate_wrapper = document.querySelector('.estimate_wrapper');
    estimate_wrapper.classList.toggle('appear');
